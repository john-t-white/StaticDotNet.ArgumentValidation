...
public sealed class ParseDateOnlyExact {
	...
	public void ReturnsCorrectly() {
		...
		ArgInfo<DateOnly> result = ReadOnlySpanCharParsingExtensions.ParseDateOnlyExact( argInfo, format );
	...
	public void WithProviderReturnsCorrectly() {
		...
		ArgInfo<DateOnly> result = ReadOnlySpanCharParsingExtensions.ParseDateOnlyExact( argInfo, format, provider );
	...
	public void WithStylesReturnsCorrectly() {
		...
		ArgInfo<DateOnly> result = ReadOnlySpanCharParsingExtensions.ParseDateOnlyExact( argInfo, format, styles: styles );
	...
	public void WithInvalidValueThrowsArgumentException() {
		...
		ArgumentException exception = Assert.Throws<ArgumentException>( name, () => {
			...
			_ = ReadOnlySpanCharParsingExtensions.ParseDateOnlyExact( argInfo, format );
		} );
	...
	public void WithMultipleFormatsReturnsCorrectly() {
		...
		ArgInfo<DateOnly> result = ReadOnlySpanCharParsingExtensions.ParseDateOnlyExact( argInfo, formats );
	...
	public void WithMultipleFormatsAndProviderReturnsCorrectly() {
		...
		ArgInfo<DateOnly> result = ReadOnlySpanCharParsingExtensions.ParseDateOnlyExact( argInfo, formats, provider );
	...
	public void WithMultipleFormatsAndStylesReturnsCorrectly() {
		...
		ArgInfo<DateOnly> result = ReadOnlySpanCharParsingExtensions.ParseDateOnlyExact( argInfo, formats, styles: styles );
	...
	public void WithMultipleFormatsAndInvalidValueThrowsArgumentException() {
		...
		ArgumentException exception = Assert.Throws<ArgumentException>( name, () => {
			...
			ReadOnlySpanArgInfo<char> argInfo = new( argumentValue, name, null );
			_ = ReadOnlySpanCharParsingExtensions.ParseDateOnlyExact( argInfo, formats );
		} );
