...
public sealed class RangeExtensions_GreaterThan_Struct {
	...
	public void WithValueGreaterThanComparisonValueReturnsCorrectly() {
		...
		int result = Arg.Is.GreaterThan( value, comparisonValue );
	...
	public void WithValueNotGreaterThanComparisonValueThrowsArgumentOutOfRangeException( int value ) {
		...
		ArgumentOutOfRangeException exception = Assert.Throws<ArgumentOutOfRangeException>( nameof( value ), () => Arg.Is.GreaterThan( value, comparisonValue ) );
	...
	public void WithValueNotGreaterThanComparisonValueAndNameThrowsArgumentOutOfRangeException() {
		...
		_ = Assert.Throws<ArgumentOutOfRangeException>( name, () => Arg.Is.GreaterThan( value, comparisonValue, name ) );
	}
	...
	public void WithValueNotGreaterThanComparisonValueAndMessageThrowsArgumentOutOfRangeException() {
		...
		ArgumentException exception = Assert.Throws<ArgumentOutOfRangeException>( nameof(value), () => Arg.Is.GreaterThan( value, comparisonValue, message: message ) );
	...
	public void WithValueAndComparerReturnsCorrectly() {
		...
		int result = Arg.Is.GreaterThan( value, comparisonValue, comparer );
	...
	public void WithNullableValueNotGreaterThanComparisonValueAndMessageThrowsArgumentOutOfRangeException() {
		...
		ArgumentOutOfRangeException exception = Assert.Throws<ArgumentOutOfRangeException>( nameof( value ), () => Arg.Is.GreaterThan( value, comparisonValue, message: message ) );
