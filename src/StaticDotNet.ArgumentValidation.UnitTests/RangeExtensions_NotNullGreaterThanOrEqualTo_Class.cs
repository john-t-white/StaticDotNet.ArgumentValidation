...
public sealed class RangeExtensions_NotNullGreaterThanOrEqualTo_Class {
	...
	public void WithValueGreaterThanOrEqualToComparisonValueReturnsCorrectly( string value ) {
		...
		string result = Arg.Is.NotNullGreaterThanOrEqualTo( value, comparisonValue );
	...
	public void WithNullValueThrowsArgumentNullException() {
		...
		_ = Assert.Throws<ArgumentNullException>( name, () => Arg.Is.NotNullGreaterThanOrEqualTo( value, comparisonValue, name ) );
	}
	...
	public void WithValueAndComparerReturnsCorrectly() {
		...
		string result = Arg.Is.NotNullGreaterThanOrEqualTo( value, comparisonValue, comparer );
