...
public sealed class RangeExtensions_NotNullGreaterThanOrEqualTo_Struct {
	...
	public void WithValueGreaterThanOrEqualToComparisonValueReturnsCorrectly(int value) {
		...
		int result = Arg.Is.NotNullGreaterThanOrEqualTo( value, comparisonValue );
	...
	public void WithValueNotGreaterThanOrEqualToComparisonValueThrowsArgumentOutOfRangeException() {
		...
		ArgumentOutOfRangeException exception = Assert.Throws<ArgumentOutOfRangeException>( nameof( value ), () => Arg.Is.NotNullGreaterThanOrEqualTo( value, comparisonValue ) );
	...
	public void WithValueNotGreaterThanOrEqualToComparisonValueAndNameThrowsArgumentOutOfRangeException() {
		...
		_ = Assert.Throws<ArgumentOutOfRangeException>( name, () => Arg.Is.NotNullGreaterThanOrEqualTo( value, comparisonValue, name ) );
	}
	...
	public void WithValueNotGreaterThanOrEqualToComparisonValueAndMessageThrowsArgumentOutOfRangeException() {
		...
		ArgumentException exception = Assert.Throws<ArgumentOutOfRangeException>( nameof(value), () => Arg.Is.NotNullGreaterThanOrEqualTo( value, comparisonValue, message: message ) );
	...
	public void WithValueAndComparerReturnsCorrectly() {
		...
		int result = Arg.Is.NotNullGreaterThanOrEqualTo( value, comparisonValue, comparer );
	...
	public void WithNullableNullValueReturnsCorrectly() {
		...
		_ = Assert.Throws<ArgumentNullException>( nameof( value ), () => Arg.Is.NotNullGreaterThanOrEqualTo( value, comparisonValue ) );
	}
	...
	public void WithNullableValueNotGreaterThanOrEqualToComparisonValueAndMessageThrowsArgumentOutOfRangeException() {
		...
		ArgumentOutOfRangeException exception = Assert.Throws<ArgumentOutOfRangeException>( nameof( value ), () => Arg.Is.NotNullGreaterThanOrEqualTo( value, comparisonValue, message: message ) );
