...
public class NotNullOrEmptyIDictionaryBenchmarks {
	...
	public Dictionary<string, string> value = new Dictionary<string, string>() { { "Key", "Value" } };
	...
	[Benchmark]
	public Dictionary<string, string> Ardalis_Guard() => ( Dictionary<string, string> )Ardalis.GuardClauses.Guard.Against.NullOrEmpty( this.value );

	[Benchmark]
	public Dictionary<string, string> Ensure_That() {
