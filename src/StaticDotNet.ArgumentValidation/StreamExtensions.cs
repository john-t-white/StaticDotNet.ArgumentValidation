...
public static class StreamExtensions {
	...
	[return: NotNull]
	public static T NotNullReadable<T>( this Arg argument, [NotNull] T? value, [CallerArgumentExpression( nameof( value ) )] string? name = null, string? message = null )
		where T : Stream
	...
	public static T? Readable<T>( this Arg _, T? value, [CallerArgumentExpression( nameof( value ) )] string? name = null, string? message = null )
		where T : Stream
			=> value?.CanRead == false
	...
	[return: NotNull]
	public static T NotNullWriteable<T>( this Arg argument, [NotNull] T? value, [CallerArgumentExpression( nameof( value ) )] string? name = null, string? message = null )
		where T : Stream
	...
	/// <exception cref="ArgumentException">Thrown when <paramref name="value"/> is not writable.</exception>
	[return: NotNullIfNotNull( nameof( value ) )]
	public static T? Writeable<T>( this Arg _, T? value, [CallerArgumentExpression( nameof( value ) )] string? name = null, string? message = null )
		where T : Stream
