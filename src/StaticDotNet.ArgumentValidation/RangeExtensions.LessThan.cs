...
public static partial class RangeExtensions {
	...
	public static T NotNullLessThan<T>( this Arg argument, [NotNull] T? value, T comparisonValue, [CallerArgumentExpression( nameof( value ) )] string? name = null, string? message = null )
		where T : struct, IComparable<T>
		=> argument.LessThan( argument.NotNull( value, name, message ), comparisonValue, name, message );
	...
	/// <exception cref="ArgumentException">Thrown when <paramref name="value"/> is not less than <paramref name="comparisonValue"/>.</exception>
	[return: NotNull]
	public static T NotNullLessThan<T>( this Arg argument, [NotNull] T? value, T comparisonValue, IComparer<T> comparer, [CallerArgumentExpression( nameof( value ) )] string? name = null, string? message = null )
	...
	public static T? LessThan<T>( this Arg _, T? value, T comparisonValue, [CallerArgumentExpression( nameof( value ) )] string? name = null, string? message = null )
		where T : struct, IComparable<T>
		=> !( value?.CompareTo( comparisonValue ) >= 0 )
			? value
			: throw new ArgumentOutOfRangeException( name, message ?? string.Format( CultureInfo.InvariantCulture, Constants.VALUE_MUST_BE_LESS_THAN, comparisonValue.ToString() ) );
	...
	/// <exception cref="ArgumentException">Thrown when <paramref name="value"/> is not less than <paramref name="comparisonValue"/>.</exception>
	[return: NotNullIfNotNull( nameof( value ) )]
	public static T LessThan<T>( this Arg _, T value, T comparisonValue, IComparer<T> comparer, [CallerArgumentExpression( nameof( value ) )] string? name = null, string? message = null )
