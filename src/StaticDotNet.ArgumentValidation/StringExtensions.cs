...
public static class StringExtensions {
	...
	public static string NotNullOrWhiteSpace( this Arg argument, [NotNull] string? value, [CallerArgumentExpression( nameof( value ) )] string? name = null, string? message = null )
	...
	public static string? NotWhiteSpace( this Arg _, string? value, [CallerArgumentExpression( nameof( value ) )] string? name = null, string? message = null )
		=> value?.Trim().Length == 0
			? throw new ArgumentException( message ?? Constants.VALUE_CANNOT_BE_WHITE_SPACE, name )
			: value;
	...
	public static string NotNullOrEmpty( this Arg argument, [NotNull] string? value, [CallerArgumentExpression( nameof( value ) )] string? name = null, string? message = null )
	...
	/// <exception cref="ArgumentException">Thrown when <paramref name="value"/> is empty.</exception>
	[return: NotNullIfNotNull( nameof( value ) )]
	public static string? NotEmpty( this Arg _, string? value, [CallerArgumentExpression( nameof( value ) )] string? name = null, string? message = null )
		=> value?.Length == 0
			? throw new ArgumentException( message ?? Constants.VALUE_CANNOT_BE_EMPTY, name )
			: value;
}
