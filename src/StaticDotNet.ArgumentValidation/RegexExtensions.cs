...
public static partial class RegexExtensions {
	...
	public static string NotNullOrWhiteSpaceMatch( this Arg argument, [NotNull] string? value, [StringSyntax( StringSyntaxAttribute.Regex )] string pattern, [CallerArgumentExpression( nameof( value ) )] string? name = null, string? message = null )
	...
	public static string? Match( this Arg _, string? value, [StringSyntax( StringSyntaxAttribute.Regex )] string pattern, [CallerArgumentExpression( nameof( value ) )] string? name = null, string? message = null )
		=> value == null
			? null
	...
	public static string NotNullOrWhiteSpaceMatch( this Arg argument, [NotNull] string? value, [StringSyntax( StringSyntaxAttribute.Regex )] string pattern, out Match match, [CallerArgumentExpression( nameof( value ) )] string? name = null, string? message = null )
	...
	/// <exception cref="ArgumentException">Thrown when <paramref name="value"/> does not match <paramref name="pattern"/>.</exception>
	[return: NotNullIfNotNull( nameof( value ) )]
	public static string? Match( this Arg _, string? value, [StringSyntax( StringSyntaxAttribute.Regex )] string pattern, out Match match, [CallerArgumentExpression( nameof( value ) )] string? name = null, string? message = null ) {
	...
	public static string NotNullOrWhiteSpaceMatch( this Arg argument, [NotNull] string? value, Regex regex, [CallerArgumentExpression( nameof( value ) )] string? name = null, string? message = null )
	...
	[return: NotNullIfNotNull( nameof( value ) )]
	public static string? Match( this Arg _, string? value, Regex regex, [CallerArgumentExpression( nameof( value ) )] string? name = null, string? message = null )
		=> value == null
			? null
	...
	public static string NotNullOrWhiteSpaceMatch( this Arg argument, [NotNull] string? value, Regex regex, out Match match, [CallerArgumentExpression( nameof( value ) )] string? name = null, string? message = null )
	...
	/// <exception cref="ArgumentException">Thrown when <paramref name="value"/> does not match <paramref name="regex"/>.</exception>
	[return: NotNullIfNotNull( nameof( value ) )]
	public static string? Match( this Arg _, string? value, Regex regex, out Match match, [CallerArgumentExpression( nameof( value ) )] string? name = null, string? message = null ) {
