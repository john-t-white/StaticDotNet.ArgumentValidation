...
public sealed class RangeExtensions_NotNullLessThan_Struct {
	...
	public void WithValueLessThanComparisonValueReturnsCorrectly() {
		...
		int result = Argument.Is.NotNullLessThan( value, comparisonValue );
	...
	public void WithValueNotLessThanComparisonValueThrowsArgumentOutOfRangeException( int value ) {
		...
		ArgumentOutOfRangeException exception = Assert.Throws<ArgumentOutOfRangeException>( nameof( value ), () => Argument.Is.NotNullLessThan( value, comparisonValue ) );
	...
	public void WithValueNotLessThanComparisonValueAndNameThrowsArgumentOutOfRangeException() {
		...
		_ = Assert.Throws<ArgumentOutOfRangeException>( name, () => Argument.Is.NotNullLessThan( value, comparisonValue, name ) );
	}
	...
	public void WithValueNotLessThanComparisonValueAndMessageThrowsArgumentOutOfRangeException() {
		...
		ArgumentException exception = Assert.Throws<ArgumentOutOfRangeException>( nameof(value), () => Argument.Is.NotNullLessThan( value, comparisonValue, message: message ) );
	...
	public void WithValueAndComparerReturnsCorrectly() {
		...
		int result = Argument.Is.NotNullLessThan( value, comparisonValue, comparer );
	...
	public void WithNullableNullValueReturnsCorrectly() {
		...
		_ = Assert.Throws<ArgumentNullException>( nameof( value ), () => Argument.Is.NotNullLessThan( value, comparisonValue ) );
	}
	...
	public void WithNullableValueNotLessThanComparisonValueAndMessageThrowsArgumentOutOfRangeException() {
		...
		ArgumentOutOfRangeException exception = Assert.Throws<ArgumentOutOfRangeException>( nameof( value ), () => Argument.Is.NotNullLessThan( value, comparisonValue, message: message ) );
